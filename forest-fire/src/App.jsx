    ...
    <div className="App" style={{display: "flex", flexDirection: "column", alignContent: "center", alignItems: "center"}}>
      ...
      <div style={{height: "100vh", width: "80%"}}>
        <MapContainer center={[63.446827, 10.421906]} zoom={13} radius={20}>
          ...
          />
          <WarningCircle color={"yellow"} lat={"62.398519442261495"} long={"10.666932529755468"} radius={100}/>
          <WarningCircle color={"red"} lat={"63.398519442261495"} long={"10.666932529758468"} radius={100}/>
        </MapContainer>
      </div>
    </div>
  );
